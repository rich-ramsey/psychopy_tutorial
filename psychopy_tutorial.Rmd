...
# Best practice and Useful to know #
...
routine repeats), in the background, the code is using [Methods] to adjust 
...
knitr::include_graphics(c("img/img24a.png", "img/img24b.png"))
```
